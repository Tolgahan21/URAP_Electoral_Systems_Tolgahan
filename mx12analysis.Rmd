...
stargazer(Mexico_model, header = FALSE, type='latex', title = " Electoral Institutions and Compeitiveness (ITAM)")
```
...
stargazer(American_model, header = FALSE, type='latex', title = "Electoral Institutions and Compeitiveness (UIUC students)")
```
...
stargazer(Pooled_model, header = FALSE, type='latex', title = "Electoral Institutions and Compeitiveness (Pooled Data)")
```
