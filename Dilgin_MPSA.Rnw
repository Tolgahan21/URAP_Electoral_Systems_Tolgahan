...
\section{Conclusion}
\iffalse Based on your data, how can you now answer your original problem? Did you prove or disprove your hypothesis?  Where do you plan to go from here? \fi
...
\iffalse
Afrobarometer's conditions that I agreed:
to acknowledge Afrobarometer as the source of the data in all publications resulting from its use by means of bibliographic citation in this form:
Afrobarometer Data, [Country(ies)], [Round(s)], [Year(s)],available at http://www.afrobarometer.org
5.	to acknowledge AidData as the source of the geocodes in all publications resulting from its use by means of bibliographic citation in this form:
...
\iffalse
Gosnell (1930), which I ordered through UIUC, has asked the question of the impact of electoral rules on the variance of turnout.
\fi
